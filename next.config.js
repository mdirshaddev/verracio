...
/* The code block you provided is creating a configuration object for Next.js. This object contains
various configurations for the Next.js application. */
...
const nextConfig = {
  images: {
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'res.cloudinary.com' // Unsplash Images
      }
    ]
  },
  headers: async () => {
...
const withPWA = withPWAConfig({
  ...
  swSrc: './src/services/workers/service-worker.js'
});
