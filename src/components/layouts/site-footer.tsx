...
import { CommandDialogMenu } from './command';
import { checklyConfig } from './configs/checky';
          ...
          <HoverCard>
            <HoverCardTrigger asChild>
              <a
                ...
                className='cursor-newtab flex h-9 items-center gap-2 rounded-md border border-[#ececec] px-3 py-2 hover:bg-primary dark:border-[#222]'
                rel='noopener'>
                <p>Checkly</p>
                <div>
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <a
                  ...
                  target='_blank'
                  className='cursor-newtab flex w-full items-center gap-2 rounded-md border border-[#ececec] px-3 py-2 hover:bg-primary dark:border-[#222]'>
                  <Icons.social.github />
                  Source Code
                </a>
              </HoverCardTrigger>
